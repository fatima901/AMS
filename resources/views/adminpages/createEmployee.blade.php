            ...
            <div class="card-body">
                <div class="collapse" id="companyDetails">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('role',['employee' => 'Employee', 'admin' => 'Admin','manager' => 'Manager'], 'employee' ,['class'=>'form-control'])}}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('employee_status',['active' => 'Active', 'inactive' => 'Inactive'], 'active' ,['class'=>'form-control'])}}
                    </div>
                </div>
            </div>
